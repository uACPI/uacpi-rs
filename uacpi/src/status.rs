...
impl UacpiError {
    ...
    pub fn from_raw(value: i32) -> Result<(), UacpiError> {
        match value {
            ...
            uacpi_sys::UACPI_STATUS_NAMESPACE_NODE_DANGLING => Err(UacpiError::NamespaceNodeDangling),
            ...
            uacpi_sys::UACPI_STATUS_AML_UNDEFINED_REFERENCE => Err(UacpiError::AmlUndefindedReference),
            uacpi_sys::UACPI_STATUS_AML_INVALID_NAMESTRING => Err(UacpiError::AmlInvalidNamestring),
            uacpi_sys::UACPI_STATUS_AML_OBJECT_ALREADY_EXISTS => Err(UacpiError::AmlObjectAlreadyExists),
            uacpi_sys::UACPI_STATUS_AML_INVALID_OPCODE => Err(UacpiError::AmlInvalidOpcode),
            uacpi_sys::UACPI_STATUS_AML_INCOMPATIBLE_OBJECT_TYPE => Err(UacpiError::AmlIncompatibleObjectType),
            ...
            uacpi_sys::UACPI_STATUS_AML_CALL_STACK_DEPTH_LIMIT => Err(UacpiError::AmlCallStackDepthLimit),
    ...
    pub fn to_string(&self) -> &str {
        match self {
            ...
            UacpiError::AmlSyncLevelTooHigh => "AML attempted to acquire a mutex with a lower sync level",
